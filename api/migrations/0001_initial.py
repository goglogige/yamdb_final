# Generated by Django 3.0.5 on 2020-10-10 15:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='titles_category', to='api.Category')),
                ('genre', models.ManyToManyField(related_name='titles_genre', to='api.Genre')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
